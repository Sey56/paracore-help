---
title: 06 - Revit vs Paracore Selection
sidebar_label: 06 - Revit vs Paracore Selection
...
*Next Step: Practice picking elements in the [06 - Step-by-Step Exercise](./step-by-step/06-step-by-step.mdx).*
