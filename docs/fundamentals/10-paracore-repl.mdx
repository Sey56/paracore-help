...
*Next Step: Explore the standalone [Interactive REPL Guide](../interactive-repl/index.mdx) for a complete reference of extension methods and visualization tools.*
