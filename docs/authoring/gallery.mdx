...
:::tip Container Requirement
You cannot load standalone `.cs` files into the gallery; they must reside within a valid [Script Source](../fundamentals/01-script-sources-and-structure.mdx) to be discovered and managed. 
:::
