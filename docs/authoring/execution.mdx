...
-   **AI Fix**: When a failure occurs, copy the error from the **History** tab and paste it into your AI coding assistant in VS Code (Copilot, Cline, etc.) — it has full context of your project files and can suggest a fix.
