...
Use VS Code AI assistants to create reusable gallery tools with editable parameters. For live conversational Revit control, see the [Paracore MCP](../ai-agent/mcp-server.mdx).

## The Two AI Workflows

| | AI Script Generation | Paracore MCP |
|---|---|---|
| **Where** | VS Code | Claude Desktop, Cursor, VS Code |
