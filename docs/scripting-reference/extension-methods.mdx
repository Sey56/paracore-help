...
## Element Accessors (Instance-Level)
Paracore extends the Revit `Element` class with smart, unit-aware getters and setters. These read **instance parameters** and fall back to C# properties via Reflection.
...
// With tolerance (filters out contact/flashing)
GetElements("Walls")
