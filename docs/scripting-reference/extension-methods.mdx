...
| **`.ReflectionMethods()`** | All public C# methods via Reflection (name, return type, parameters, declaring type). | `wall.ReflectionMethods().Table()` |
...
*\* ⚠️ This feature is not available in the free build. See [Feature Availability](../enterprise/index.md) for details.*
