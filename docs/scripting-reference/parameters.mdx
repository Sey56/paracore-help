...
> 📖 **API Reference**: Detailed documentation of every extension method and global object can be found in the **[Paracore Extension Methods](../extension-methods/index.mdx)**.
