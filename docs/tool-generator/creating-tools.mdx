...
In the **Script Gallery**, select the script project you wish to package.
...
- For project scripts, this window displays the **Combined Logic** that the engine has resolved from your `Scripts/` folder. This is exactly what will be compiled into your tool.
