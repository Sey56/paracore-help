...
To use Paracore or the VSCode extension, you **must** first install the **Paracore Addin for Revit**.
:::

### 1. Paracore Addin for Revit
...
*   **Version:** `v2.1.0` (Latest Stable)
*   **File:** `Paracore_2.1.0_x64.msi`
*   **Download:** [Download Paracore v2.1.0](https://github.com/Sey56/Paracore/releases)

:::tip Recommended Update
Version 2.1.0 introduces automatic unit conversion, real-time multi-file sync, and significant engine refinements.
:::
