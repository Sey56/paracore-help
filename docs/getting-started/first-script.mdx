...
**Note**: The "TwistingTower" script used here is just to demonstrate Paracore's capabilities. Don't worry about understanding its code yet! We will start from scratch in the [Tutorials](../tutorials/index.md).
...
## 🎯 Goal
Experience **Dynamic Execution** in action. Run a pre-made script to see how Paracore instantly compiles and executes code without restarting Revit.
...
3.  Click the **Compute (🔄)** button next to the **BaseLevelName** and **WallTypeName** fields to fetch live data from your Revit project.
