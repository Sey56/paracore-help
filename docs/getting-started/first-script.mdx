...
> [!TIP]
> **v3.0.3+**: You can select the root `Paracore-Examples` folder directly. Paracore will automatically discover all script sources inside it (folders containing a `.paracore` marker file). Switch between sources using the **Script Sources** dropdown in the Sidebar.
